# Zsh Terminal Bootstrap (macOS / Linux)

A modular Zsh profile that mirrors the PowerShell and Bash setups with:
...
## Wire This Profile Into Zsh

Add this line to your `.zshrc`:

```zsh
source "$HOME/path/to/sm-windows-terminal-profiles/zsh/profile/main_profile.zsh"
```
...
The Zsh profile also accepts the legacy `GitRepoRootDir` and `GitRepoSearchDepth` names for compatibility.
...
```zsh
export GIT_BROWSE_OPEN_CMD='open {url}'
```
